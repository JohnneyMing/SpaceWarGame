...
public class SpaceGameServer 
{
		...
		try {
			...
			while( playing ){
				...
				try {
					...
					System.out.println("createPersistentClientConnections() ");
				}
			}
	...
	protected void createObstacles() 
	{
		...
		{	
			sector.addObstacle( new Obstacle( rand.nextInt(Constants.MAX_SECTOR_X),rand.nextInt(Constants.MAX_SECTOR_Y) ) );
		}
	} // end createObstacles
